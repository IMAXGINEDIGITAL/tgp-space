...
/***/ function(module, exports) {
	...
	(function (fn) {
	    ...
	    function updateMap(x, y) {
	        ...
	        mapIndiEl.style.transform = 'translate3d(' + x + 'px,' + y + 'px, 0px)';
	    }
	    ...
	    function makeNoise() {
	        ...
	        walkMatrix(0, 0, stageView.width, stageView.height, function (x, y) {
	            var value = simplex.noise2D(x, y);
	            if (value > 0.00001) {
	                setColorVectorInImageData(noiseImageData.data, x, y, stageView.width, stageView.height, [255, 255, 255, value * 255]);
	            }
	        });
	    ...
	    function startClearNoise(x, y, lastX, lastY, clearByPath) {
	        ...
	        for (var i = 1; i <= stepAmount; i++) {
	            ...
	            var r = 0;
	            while (r < Math.abs(stageNoiseView.height - cy) && r < stageNoiseView.height / 2) {
	                r += radius;
