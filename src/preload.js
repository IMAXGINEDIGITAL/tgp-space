...
const loadGameManifest = viewport => new Promise((resolve, reject) => {
    ...
    queue.loadManifest({
        ...
        manifest: [
            ...
            {id: 'cloud-1', src: 'cloud-1.png'},
            {id: 'cloud-2', src: 'cloud-2.png'},
            {id: 'cloud-3', src: 'cloud-3.png'},
            {id: 'cloud-4', src: 'cloud-4.png'},
            {id: 'cloud-5', src: 'cloud-5.png'},
            {id: 'cloud-6', src: 'cloud-6.png'},
            {id: 'cloud-7', src: 'cloud-7.png'},
            {id: 'cloud-8', src: 'cloud-8.png'},
            {id: 'cloud-mask', src: 'cloud-mask.png'},
